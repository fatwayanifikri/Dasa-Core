...
<p style="text-align: center;"><strong><span style="text-decoration: underline;"><center>FORM TIDAK ABSEN</center></span></strong></p>
<div class="col-sm-12">
...
<tr>
<td align="left"><b>Jam</td>
<td align="left">: {{$p->jam_pelaksanaan}}</td>
</tr>
...
<td style="text-align: center">ADMIN UMUM</td>
...
<center>{{ ($p->is_approve == 2) ? 'Disetujui' : 'Blm Di Setujui'}}</center></td>
