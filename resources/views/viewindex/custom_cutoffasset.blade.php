...
<p class="split-para">
<a href="cutoffasset?Unit_id={{ request('Unit_id') }}" class="btn btn-success"  title="Cut Off">
<i class="fa fa-copy"> Cut Off</i></a>   
...
<option value="">-Select Unit Yang Ingin Di Cut Off-</option>
@foreach($value as $p)
