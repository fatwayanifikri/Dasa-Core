...
<a href="downloadExcelVoucher2/xlsx?from={{ request('from') }}&until={{ request('until') }}&Unit_id={{ request('Unit_id') }}" class="btn btn-success"  title="Print Excel">
<i class="fa fa-file-excel-o"> xlsx</i></a>

<a href="printvoucher2pdf?from={{ request('from') }}&until={{ request('until') }}&Unit_id={{ request('Unit_id') }}" class="btn btn-danger"  title="Print Pdf">
...
<span>
<a href="../admin/t112_absenlemburvoucherfinance" class="btn btn-primary btn-sm"  title="Back">
...
<div class="modal-body">
 <!------------------------SEARCH TANGGAL---------------------------->
<form>   
<label>Tanggal Pengajuan Voucher</label><br></br>
<table><tr>
<td>From :&nbsp</td><td>
...
<a class = "link" href="../admin/export_voucher_finance" ><button type="reset" class="btn btn-danger" title="Reset">Reset</a>
</button>
