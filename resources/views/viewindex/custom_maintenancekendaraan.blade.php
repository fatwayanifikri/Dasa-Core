...
<a href="#" class="btn btn-success"  title="Print Excel">
<i class="fa fa-file-excel-o"> xlsx</i></a>

<a href="printallmainkenpdf?Unit_id={{ request('Unit_id') }}&from={{ request('from') }}&until={{ request('until') }}&EmployeeName={{ request('EmployeeName') }}" class="btn btn-danger"  title="Print Pdf">
...
<span>
<a href="../admin/maintenance_kendaraan" class="btn btn-primary btn-sm"  title="Back">
...
<select name="EmployeeName" class="form-control " placeholder="Cari Karyawan .." value="{{ request('EmployeeName') }}"  >  
<option value="">-Select Employee-</option>
@foreach($fill as $e)
<option value="{{$e->EmployeeName}}">{{$e->EmployeeName}}</option>
@endforeach
</select>
<br>

<input type="submit" class="btn btn-primary" value="Apply" title="Apply">
<a class = "link" href="../admin/maintenance_kendaraan_print" ><button type="reset" class="btn btn-danger" title="Reset">Reset</a>
</button>
</form>
<!---------------------------END SEARCH---------------------------->
</div>
