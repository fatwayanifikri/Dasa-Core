...
<a href="downloadExcel6/xlsx?Unit_id={{ request('Unit_id') }}&from={{ request('from') }}&until={{ request('until') }}" class="btn btn-success"  title="Print Excel">
...
<span>
<a href="../admin/p103_resignemployee" class="btn btn-primary btn-sm"  title="Back">
...
@foreach($result ->sortByDesc('TanggalKeluar' ) as $p)
<tr>
...
<a href="../admin/p103_resignemployee" class="btn btn-primary btn-sm" title="Show">
<i class="fa fa-eye"></i></a>  
<a href="../admin/p103_resignemployee" class="btn btn-success btn-sm" title="Edit">
<i class="fa fa-pencil"></i></a>  
<a href="../admin/p103_resignemployee" class="btn btn-warning btn-sm" title="Delete">
...
<a class = "link" href="../admin/p103_resignemployees"> <button type="reset" class="btn btn-danger" title="Reset">Reset
</a>
</button>
</center>
</form> 
