...
<td><button type="button" title="Clear" onclick="location.href='../admin/produksi_operator'"><i class="fa fa-backward"></i></button></td>
</tr>
...
@if($p->status_produksi =='1') 
<td>
<a href="{{ url('admin/update_status_to_proses2/'.$p->id) }}" class="btn btn-warning btn-sm"  title="Add">Proses</a>
</td>
@elseif($p->status_produksi =='2') 
<td>
<a href="{{ url('admin/update_status_to_selesai2/'.$p->id) }}" class="btn btn-success btn-sm"  title="Add">Selesai</a>
</td>
@else
<td>
</td>
