...
<a href="downloadExcelVoucher3/xlsx?from={{ request('from') }}&until={{ request('until') }}&Unit_id={{ request('Unit_id') }}&isVoucher={{ request('isVoucher') }}" class="btn btn-success"  title="Print Excel">
<i class="fa fa-file-excel-o"> xlsx</i></a>

<a href="printvoucher3pdf?from={{ request('from') }}&until={{ request('until') }}&Unit_id={{ request('Unit_id') }}&isVoucher={{ request('isVoucher') }}" class="btn btn-danger"  title="Print Pdf">
...
<span>
<a href="../admin/t112_absenlemburvoucher" class="btn btn-primary btn-sm"  title="Back">
...
<a class = "link" href="../admin/export_pengajuan_voucher" ><button type="reset" class="btn btn-danger" title="Reset">Reset</a>
</button>
