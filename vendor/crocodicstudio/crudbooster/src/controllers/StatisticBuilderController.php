...
class StatisticBuilderController extends CBController
{
    ...
    public function getDashboard()
    {
        ...
        //shandy
        $menus= DB::table('cms_menus')->whereRaw("cms_menus.id IN (select id_cms_menus from cms_menus_privileges where id_cms_privileges = '".CRUDBooster::myPrivilegeId()."')")->where('is_dashboard', 1)->whereNull('deleted_at')->where('is_active', 1)->first();
        //shandy
