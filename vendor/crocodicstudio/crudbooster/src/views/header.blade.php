    ...
    <!--shandy-->
        ...
        <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title="{{Session::get('appname')}}" class="logo">
            <span class="logo-mini">
                <img src="{{Session::get('LogoSmall')}}" id="ImgLogoMini" alt="DP" style="width: 50px; height: 50px;" />
            </span>
            <span class="logo-lg">
                <img src="{{Session::get('Logo')}}" id="ImgLogoLarge" alt="{{CRUDBooster::getSetting('appname')}}" style="width: 200px; height: 50px;" />
            </span>
        </a>
    <!--shandy-->
    <!-- Header Navbar -->
