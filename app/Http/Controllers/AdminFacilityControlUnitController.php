<?php namespace App\Http\Controllers;
	...
	class AdminFacilityControlUnitController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	      ...
	      ->where('id', \DB::raw("(select max(`id`) from hgst100_reqmaintenance)"))
	  	  ...
	  	  $ResultID = $id + 1;
	  	   ...
	  	   $Jabatan=DB::table('hgst102_reqmaintenancekategori')
			 		->value('kategoriname');
	 ...
	 //  $id=DB::Table('hgst102_reqmaintenancekategori')
	 // 	  ->value('id');
	 //  $kategori=DB::Table('hgst102_reqmaintenancekategori')
	 // 	  ->value('kategoriname');
	 
	 // //$reqid = DB::table('hgst101_reqmaintenancedetail')->orderBy('id','desc')->first();

	 //   DB::table('hgst101_reqmaintenancedetail')->where('kategori','=',$id)->update(['kategori'=>$kategori]);
	    }
