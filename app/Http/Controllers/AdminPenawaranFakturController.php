<?php namespace App\Http\Controllers;
	...
	class AdminPenawaranFakturController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "mkt004_faktur";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Nomor Faktur","name"=>"Nomor_faktur"];
			...
			$this->form[] = ['label'=>'Nomor Faktur','name'=>'Nomor_faktur','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"PenawaranID","name"=>"PenawaranID","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Nomor Faktur","name"=>"Nomor_faktur","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"SalesID","name"=>"SalesID","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
		...
		$penawaran_id=DB::table('mkt005_fakturdetail')
			->where('id', \DB::raw("(select max(`id`) from mkt005_fakturdetail)"))
		    ->value('PenawaranID');

       DB::table('mkt004_faktur')->where('id',$edit_id)->update(['PenawaranID'=>$penawaran_id]);

        redirect('admin/penawaran_harga')->send();
