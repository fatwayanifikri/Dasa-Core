<?php namespace App\Http\Controllers;
	...
	class AdminEditcmsUsersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	       ...
	       $this->form[] = array("label"=>"Photo","name"=>"photo","type"=>"upload","help"=>"Recommended resolution is 200x200px",'required'=>true,'validation'=>'required|image|max:2000','resize_width'=>90,'resize_height'=>90);											
			$this->form[] = array("label"=>"Jabatan","name"=>"id_cms_privileges","type"=>"select2","datatable"=>"cms_privileges,name",'disabled'=>true);	
			$this->form[] = array("label"=>"Unit","name"=>"Unit_id","type"=>"select","datatable"=>"hrdm101_unit,UnitName",'disabled'=>true);					
			// $this->form[] = array("label"=>"Password","name"=>"password","type"=>"password","help"=>"Please leave empty if not change");
			$this->form[] = array("label"=>"New Password","name"=>"password","type"=>"password","help"=>"Please leave if not change");
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			$query
			->where('cms_users.Employee_id',$EmpID);
