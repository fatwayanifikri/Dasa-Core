<?php namespace App\Http\Controllers;
	...
	class AdminFormPelamarController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Telp.Hp','name'=>'TelpHp','type'=>'text','width'=>'col-sm-10','validation'=>'required|min:1|max:255'];
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
	        CRUDBooster::redirect($_SERVER['HTTP_REFERER'],"Input Data Berhasil!","info");
