<?php namespace App\Http\Controllers;
  ...
  use Redirect;
	...
	class AdminProduksiOperatorController extends \crocodicstudio\crudbooster\controllers\CBController {
...
//---------------------------
   ...
   $this->cbView('viewindex/custom_produksi_taping',$data);
  
}

public function update_status_to_proses2($id){
...
public function update_status_to_selesai2($id){
			

$get_qty = DB::Table('t208_detailproduksi')
	 ->where('id','=',$id)
	 ->value('qty_produksi');

$get_mesin_id = DB::Table('t208_detailproduksi')
	 ->where('id','=',$id)
	 ->value('mesin_id');

$get_tgl_produksi = DB::Table('t208_detailproduksi')
	 ->where('id','=',$id)
	 ->value('tgl_produksi');

$get_kapasitas_mesin= DB::Table('t207_mesinproduksi')
	 ->where('id','=',$get_mesin_id )
	 ->value('kapasitas_produksi');	 


$kapasitas_after_done = $get_kapasitas_mesin + $get_qty;

$update_kapasitas = DB::Table('t208_detailproduksi')
  ->get();

foreach ($update_kapasitas as $p) {
  DB::table('t208_detailproduksi')
  ->where('id','=',$p->id)
  ->where('mesin_id','=',$get_mesin_id)
  ->where('tgl_produksi','=',$get_tgl_produksi)
  ->update(array('kapasitas_terpakai' => DB::raw($p->kapasitas_terpakai - $get_qty)));
}

DB::table('t208_detailproduksi')
->where('id','=',$id)
->update(['qty_produksi_process'=>0]);
