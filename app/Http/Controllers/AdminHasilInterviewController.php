<?php namespace App\Http\Controllers;
	...
	class AdminHasilInterviewController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "nama_interviewer";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Interviewer","name"=>"interviewer","join"=>"hrde200_employee,EmployeeName"];
			$this->col[] = ["label"=>"Jabatan","name"=>"jabatan_interviewer","join"=>"cms_privileges,name"];
			$this->col[] = ["label"=>"Keputusan","name"=>"keputusan"];
			...
			$this->form[] = ['label'=>'Nama Interviewer','name'=>'nama_interviewer','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Nama Interviewer","name"=>"nama_interviewer","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
	        ...
	        | 
	        */
	        $this->index_button[] = ['label'=>'Add Data','url'=>('form_hasil_interview') ,'icon'=>'fa fa-plus','color'=>'success'];
