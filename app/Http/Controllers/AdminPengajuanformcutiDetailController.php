<?php namespace App\Http\Controllers;
	...
	class AdminPengajuanformcutiDetailController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Employee Id","name"=>"Employee_id","visible"=>false];
			$this->col[] = ["label"=>"Employee Name","name"=>"Employee_id","join"=>"hrde200_employee,EmployeeName"];
		...
		//	$this->form[] = ['label'=>'Unit','name'=>'Unit_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-2','datatable'=>'hrdm101_unit,UnitName','value'=>$getUnitID];
			...
			$this->form[] = ['label'=>'Pelaksanaan','name'=>'Pelaksanaan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-8'];
