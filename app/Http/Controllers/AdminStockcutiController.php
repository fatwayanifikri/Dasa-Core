<?php namespace App\Http\Controllers;
	...
	class AdminStockcutiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Starstok","name"=>"Starstok"];
			$this->col[] = ["label"=>"Endstock","name"=>"Endstock"];
			...
			$this->form[] = ['label'=>'Endstock','name'=>'Endstock','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
