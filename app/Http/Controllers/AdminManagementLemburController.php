<?php namespace App\Http\Controllers;
	...
	class AdminManagementLemburController extends \crocodicstudio\crudbooster\controllers\CBController {
        ...
        //------------------------------------------------------------------//
	        ...
	        */
	        ...
	        | 
	        */
	        $this->index_button[] = ['label'=>'Export','url'=>('export_lembur'),'icon'=>'fa fa-download','color'=>'primary'];
...
";
	    ...
	    public function hook_row_index($column_index,&$column_value) {	    
			...
			if($column_index == 8){
 			...
 			if($column_index == 9){
				...
				{
					$column_value = 'Voucher Dibuat';
				}
				elseif($column_value == 2 )
				{
					$column_value = 'Voucher Diajukan';
				}
				elseif($column_value == 3 )
				{
					$column_value = 'Voucher Dicairkan';
				}
				elseif($column_value == 4 )
				{
					$column_value = 'Voucher Diterima';
				}
				else{
	    ...
	    */
	    public function hook_after_edit($id) {
	     ...
	     $Employee_id=DB::table('t112_absenlembur')->where('id','=',$id)->value('Employee_id');
	    ...
	    */
	    ...
	    public function hapus_lembur($id){
	      ...
	      DB::table('t112_absenlembur')->where('id',$id)->delete();
