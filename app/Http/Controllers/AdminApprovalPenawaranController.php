<?php namespace App\Http\Controllers;
	...
	class AdminApprovalPenawaranController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'CostumerAddress','name'=>'CostumerAddress','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	        ...
	        */
	        ...
	        | 
	        */
	        $this->addaction[] = ['label'=>'Approve','url'=>('approvePO_SM').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[Status] == 1"];
	    ...
	    */
		...
		public function approvePO_SM($id){
			DB::table('mkt002_penawaran')->where('id',$id)->update(['Status'=>'2']);
