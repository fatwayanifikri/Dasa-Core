<?php namespace App\Http\Controllers;
	...
	class AdminLemburIndividuCbController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		//	$this->col[] = ["label"=>"Perusahaan","name"=>"Company_id","join"=>"hrdm100_company,CompanyName"];
	        ...
	        */
	        ...
	        $this->addaction[] = ['label'=>'Selesai Lembur','url'=>('endtimecb/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[AmountMinute] == 0"];
    ...
    //By the way, you can still create your own method in here... :) 
     ...
     public function endtimecb($id){
	        ...
	        $date = Carbon::now();
				...
				redirect('admin/lembur_individu_cb/edit/'.$id)->send();
