<?php namespace App\Http\Controllers;
  ...
  use Redirect;
	...
	class AdminProduksiMonitoringController extends \crocodicstudio\crudbooster\controllers\CBController {
...
$query = \App\Models\t208_detailproduksi::when(request('mesin_id'), function($query){
...
->selectRaw('tgl_produksi,kapasitas_terpakai,mesin_id, SUM(qty_produksi) as qty, MAX(kapasitas_terpakai) as kapasitas')
->groupby('tgl_produksi','mesin_id')
...
//---------------------------
   ...
   $this->cbView('viewindex/custom_produksi_monitoring',$data);
