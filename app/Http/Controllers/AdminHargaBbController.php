...
use PDF;
	...
	class AdminHargaBbController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
	        ...
	        | 
	        */
	        $this->addaction[] = ['url'=>('delete_hargabb').'/[id]','icon'=>'fa fa-trash','color'=>'danger','confirmation' => true];
	        ...
	        */
	        ...
	        | 
	        */
	        $this->index_button [] = ['label'=>'Add Data','url'=>('harga_bb_add'),'icon'=>'fa fa-plus' ,'color' => 'success' ];
