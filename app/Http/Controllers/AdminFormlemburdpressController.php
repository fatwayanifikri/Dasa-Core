<?php namespace App\Http\Controllers;
	...
	class AdminFormlemburdpressController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Karyawan','name'=>'Employee_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-4','datatable'=>'hrde200_employee,EmployeeName','datatable_where'=>'Unit_id = 2'];
			//--------------------------------//
			$this->form[] = ['label'=>'Unit','name'=>'Unit_id','type'=>'select','width'=>'col-sm-2','datatable'=>'hrdm101_unit,UnitName','value'=>$getUnitID,'disabled'=>true];
			$this->form[] = ['label'=>'Unit','name'=>'Unit_id','type'=>'hidden','width'=>'col-sm-2','datatable'=>'hrdm101_unit,UnitName','value'=>$getUnitID];
			...
			$this->form[] = ['label'=>'Nomer Voucher','name'=>'NomerVoucher','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	        ...
	        */
			...
			//     $this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('Approvallemburkaryawan/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			// }	
			...
			// }
			if(CRUDBooster::MyPrivilegeId()<>135 & CRUDBooster::MyPrivilegeId()<>134){
...
// 	        $getstartlembur=DB::Table('t112_absenlembur')
// 			   ->where('id',$id)
// 			   ->where('Unit_id','2')
// 			   ->value('StartTime');

// 	     $getendlembur=DB::Table('t112_absenlembur')
// 			   ->where('id',$id)
// 			   ->where('Unit_id','2')
// 			   ->value('EndTime');

// if($getstartlembur >= $getendlembur) {
				
// 				CRUDBooster::redirect($_SERVER['HTTP_REFERER'],"Selesai Lembur Tidak Boleh Sama Atau Kurang Dari Mulai Lembur!","danger");
// 				return false;
