<?php namespace App\Http\Controllers;
	...
	class AdminNoteRejectCutiController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	#Tambahan
	        ...
	        */
			...
			if($getUnitID == 1<=8){
				if ($getJabatan == 3 ){
					...
					$this->addaction[] = ['label'=>'Tolak','name'=>'tolak_sm','url'=>('RejectSM').'/[id]','icon'=>'fa fa-check','color'=>'danger','showIf'=>"[isApprove] == 0"];
				}
				elseif ($getJabatan == 4 ){
					$this->addaction[] = ['label'=>'Setujui','name'=>'setuju_sm','url'=>('ApproveSM').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApprove] == 0"];
					$this->addaction[] = ['label'=>'Tolak','name'=>'tolak_sm','url'=>('RejectSM').'/[id]','icon'=>'fa fa-check','color'=>'danger','showIf'=>"[isApprove] == 0"];
				...
				elseif($getJabatan == 	12){
					...
					$this->addaction[] = ['label'=>'Tolak','name'=>'tolak_sm','url'=>('RejectSM').'/[id]','icon'=>'fa fa-check','color'=>'danger','showIf'=>"[isApprove] == 1"];
       ...
       if ($dashboard && $dashboard->url) {
        return redirect('admin/Approvalformcuti')->send();
        exit;
         }
