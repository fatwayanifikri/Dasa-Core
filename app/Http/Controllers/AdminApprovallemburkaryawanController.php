<?php namespace App\Http\Controllers;
	...
	class AdminApprovallemburkaryawanController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		public function cbInit() {
			...
			$this->col[] = ["label"=>"Tgl Lembur","name"=>"StartTime"];
	...
	//		dd($dept);
			...
			$this->form[] = ['label' => 'Unit','name'=>'Unit_id','type'=> 'select2','width'=>'col-sm-2','datatable'=>'hrdm101_unit,UnitName','value' => $getUnitID];
	        ...
	        */
			...
			if(CRUDBooster::MyPrivilegeId()==1){
				...
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success'];
			}
            ...
            elseif(CRUDBooster::MyPrivilegeId()==6){
				$this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			}
			elseif(CRUDBooster::MyPrivilegeId()==7){
				$this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			}
			...
			elseif(CRUDBooster::MyPrivilegeId()==10){
				$this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			 }
			elseif(CRUDBooster::MyPrivilegeId()==11){
				$this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			}
			...
			elseif(CRUDBooster::MyPrivilegeId()==134){
				// $this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			}
			elseif(CRUDBooster::MyPrivilegeId()==135){
				// $this->addaction[] = ['label'=>'Setujui','url'=>('lembur').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[isApproved] == 0"];
				$this->addaction[] = [ 'title' => 'Edit Data', 'url' =>('FormLembur/edit/[id]'),'icon' => 'fa fa-pencil', 'color' => 'success', 'showIf' => '[isApproved] == 0'];
			}
	    ...
	    public function hook_query_index(&$query) {
			...
			if($getUnitID == 1){
					if($getJabatan == 6){
					   $query
						->where(function($q) {
						$q->where('t112_absenlembur.Jabatan_id','=','36')
					...
					elseif ($getJabatan == 7) {
						$query
						->where(function($q) {
                        $q->where('t112_absenlembur.Jabatan_id','=','69')
						...
						->orWhere('t112_absenlembur.Jabatan_id','=','109')
						->orWhere('t112_absenlembur.Jabatan_id','=','149')
						// ->orWhere('t112_absenlembur.Jabatan_id','=','147')
						->orWhere('t112_absenlembur.Jabatan_id','=','35');
                         })
						->orderBy('isApproved','asc');
					}
					elseif ($getJabatan == 8) {
						$query
						->where(function($q) {
						$q->where('t112_absenlembur.Jabatan_id','=','16')
					...
					elseif ($getJabatan == 9) {
						$query
						->where(function($q) {
						$q->where('t112_absenlembur.Jabatan_id','=','17')
					...
					elseif ($getJabatan == 5) {
						$query
						->where(function($q) {
						$q->where('t112_absenlembur.Jabatan_id','=','5')
						...
						->orWhere('t112_absenlembur.Jabatan_id','=','12')
						->orWhere('t112_absenlembur.Jabatan_id','=','80')
						->orWhere('t112_absenlembur.Jabatan_id','=','81')
						->orWhere('t112_absenlembur.Jabatan_id','=','82')
						->orWhere('t112_absenlembur.Jabatan_id','=','83')
						->orWhere('t112_absenlembur.Jabatan_id','=','84')
						->orWhere('t112_absenlembur.Jabatan_id','=','85')
						->orWhere('t112_absenlembur.Jabatan_id','=','111')
						->orWhere('t112_absenlembur.Jabatan_id','=','158');
					})
						->orderBy('isApproved','asc');
					}
					else {
			...
			elseif ($getUnitID != 1) {
				if($getJabatan == 12){
					$query
					->where('t112_absenlembur.isApproved','=',0)
				...
				if($getJabatan == 20){
					...
					->where('t112_absenlembur.Employee_id','<>',$EmpID)
					->Where('t112_absenlembur.Jabatan_id','<>','134')
				    ->Where('t112_absenlembur.Jabatan_id','<>','135')
					->Where('t112_absenlembur.Jabatan_id','<>','13')
				    ->Where('t112_absenlembur.Jabatan_id','<>','20')
					->Where('t112_absenlembur.Jabatan_id','<>','21')
					->Where('t112_absenlembur.Jabatan_id','<>','22')
					->Where('t112_absenlembur.Jabatan_id','<>','23')	
					->Where('t112_absenlembur.Jabatan_id','<>','24')	
					->Where('t112_absenlembur.Jabatan_id','<>','25')	
					->Where('t112_absenlembur.Jabatan_id','<>','26')	
					->Where('t112_absenlembur.Jabatan_id','<>','27')	
					->Where('t112_absenlembur.Jabatan_id','<>','28')	
					->Where('t112_absenlembur.Jabatan_id','<>','29')	
					->Where('t112_absenlembur.Jabatan_id','<>','30')	
					->Where('t112_absenlembur.Jabatan_id','<>','31')
					->Where('t112_absenlembur.Jabatan_id','<>','32')	
					->Where('t112_absenlembur.Jabatan_id','<>','33')
					->Where('t112_absenlembur.Jabatan_id','<>','61')
					->Where('t112_absenlembur.Jabatan_id','<>','70')
					->Where('t112_absenlembur.Jabatan_id','<>','71')
					->orderBy('isApproved','asc');
				}				
				if($getJabatan == 21){
					$query->where('t112_absenlembur.Unit_id',$getUnitID)
