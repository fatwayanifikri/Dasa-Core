<?php namespace App\Http\Controllers;
	...
	class AdminVoucherLemburHoController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		//	$this->form[] = ['label'=>'Departement','name'=>'Departement_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'hrdm102_departement,DepartementName'];
	        ...
	        */
			...
			if(CRUDBooster::MyPrivilegeId()==1){
				$this->addaction[] = ['label'=>'Buat Voucher','url'=>('VoucherBuatHO').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[AmountMinute] > 299 & [isApproved] == 1 & [isVoucher] == 0 & [Shift] <> 'Malam'" ];
			
				$this->addaction[] = ['label'=>'Diterima','url'=>('VoucherTerimaHO').'/[id]','icon'=>'fa fa-check','color'=>'success','showIf'=>"[AmountMinute] > 299 & [isApproved] == 1 & [isVoucher] == 3" ];
			}
	...
	//	dd($getJabatan);
	 ...
	 //        if($statuslembur == 0 && $waktulembur > 299){
	    ...
	    */
		...
		public function VoucherBuatHO($id){
            ...
            redirect('admin/voucher_lembur_ho/edit/'.$id)->send();

		}	

		public function VoucherTerimaHO($id){
