<?php namespace App\Http\Controllers;
	...
	class AdminFormTidakAbsenController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
		   ...
		   $this->form[] = ['label'=>'Nama Karyawan','name'=>'Employee_id','type'=>'datamodal','datamodal_table'=>'hrde200_employee','datamodal_where'=>'Unit_id='.Crudbooster::myUnitID(),'validation'=>'required|min:1|max:255','width'=>'col-sm-5','datamodal_columns'=>'EmployeeName,NPK','datamodal_columns_alias'=>'EmployeeName,NPK','datamodal_select_to'=>'Unit_id:Unit_id,Jabatan_id:Jabatan_id','datamodal_size'=>'large','required'=>true];
            ...
            $this->form[] = ['label'=>'Nama','name'=>'Employee_id','type'=>'select','width'=>'col-sm-10','datatable'=>'hrde200_employee,EmployeeName','value' =>$EmpID, 'readonly'=>true,'disabled'=>true];

            $this->form[] = ['label'=>'Nama','name'=>'Employee_id','type'=>'hidden','width'=>'col-sm-10','datatable'=>'hrde200_employee,EmployeeName','value' =>$EmpID];
            }
			...
			$this->form[] = ['label'=>'Jam Pelaksanaan','name'=>'jam_pelaksanaan','validation'=>'required|min:1|max:255','width'=>'col-sm-10','type'=>'select',"dataenum" => ["Jam Masuk Kerja","Istirahat","Selesai Istirahat","Jam Pulang Kerja"]];
	        ...
	        */
	        ...
	        $this->addaction[] = ['url'=>('delete_form1').'/[id]','icon'=>'fa fa-trash','color'=>'danger','confirmation' => true,'showIf'=>"[is_approve] == 1"];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			if($getJabatan == 1){
				...
				$query->where('t204_formtidakabsen.Employee_id',$EmpID);
			}
...
public function print_tidakabsen($id){

$query = \App\Models\t204_formtidakabsen::when(request('Unit_id'), function($query){
...
$generatePDF = PDF::loadView('exports.PrintFormTidakAbsenpdf',array('query'=>$query))->setPaper('a5','landscape');
