<?php namespace App\Http\Controllers;
	...
	class AdminHrde100PelamarController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"NamaPelamar","name"=>"NamaPelamar"];
			$this->col[] = ["label"=>"TempatLahir","name"=>"TempatLahir"];
			$this->col[] = ["label"=>"TanggalLahir","name"=>"TanggalLahir"];
			$this->col[] = ["label"=>"JenisKelamin","name"=>"JenisKelamin"];
			$this->col[] = ["label"=>"StatusNikah Id","name"=>"StatusNikah_id","join"=>"StatusNikah,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'NamaPelamar','name'=>'NamaPelamar','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Gaji','name'=>'Gaji','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'FinalApprove','name'=>'FinalApprove','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'IsApprovePKWT','name'=>'isApprovePKWT','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Gaji","name"=>"Gaji","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"FinalApprove","name"=>"FinalApprove","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"IsApprovePKWT","name"=>"isApprovePKWT","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
