...
<td><input type = "number" name="qty_produksi" class="form-control" form="mesin" ></td>
</tr>
<!---------------------------->
...
<td>{{number_format($i->qty_produksi)}}</td>
...
<center><a href="../admin/back_button" class="btn btn-warning"  title="Back">
